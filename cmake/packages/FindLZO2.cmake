...
if(LZO2_INCLUDE_DIRS AND EXISTS "${LZO2_INCLUDE_DIRS}/lzo/lzoconf.h")
  ...
  if (HAVE_LZO2_H)
    file(STRINGS "${LZO2_INCLUDE_DIRS}/lzo/lzoconf.h" _lzo_version_lines REGEX "#define[ \t]+MY_VERSION_NUMBERS")
    string(REGEX REPLACE ".*MY_VERSION_NUMBERS \"\([0-9]*\)\..*\"" "\\1" _lzo_version_major "${_lzo_version_lines}")
    string(REGEX REPLACE ".*MY_VERSION_NUMBERS \"[0-9]*\.\([0-9]*\)\"" "\\1" _lzo_version_minor "${_lzo_version_lines}")
