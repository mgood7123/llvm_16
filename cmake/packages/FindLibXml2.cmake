...
find_library(LIBXML2_LIBRARY NAMES libxml2.a
...
if(LibXml2_FOUND AND NOT TARGET LLVM_STATIC_LibXml2::LibXml2)
  ...
  find_package(LZMA)
  if (LZMA_FOUND)
      set(LLVM_STATIC_LibXml2_____LIBS ${LZMA_TARGET};${LLVM_STATIC_LibXml2_____LIBS})
  endif()
  ...
  message(STATUS "LLVM_STATIC_LibXml2_____LIBS = ${LLVM_STATIC_LibXml2_____LIBS}")
