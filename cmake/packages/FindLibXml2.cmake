...
find_library(LIBXML2_LIBRARIES NAMES xml2 libxml2 libxml2_a
...
find_program(LIBXML2_XMLLINT_EXECUTABLE xmllint
  PATHS ${CMAKE_CURRENT_BINARY_DIR}/BUILD_ROOT/ROOTFS/bin
  NO_DEFAULT_PATH
  NO_PACKAGE_ROOT_PATH
  NO_CMAKE_PATH
  NO_CMAKE_ENVIRONMENT_PATH
...
if(LibXml2_FOUND AND NOT TARGET LLVM_STATIC_LibXml2::LibXml2)
  ...
  set_property(TARGET LLVM_STATIC_LibXml2::LibXml2 APPEND PROPERTY IMPORTED_LOCATION "${LIBXML2_LIBRARY}")
