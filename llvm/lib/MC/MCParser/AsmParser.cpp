...
AsmParser::AsmParser(SourceMgr &SM, MCContext &Ctx, MCStreamer &Out,
  ...
  case MCContext::IsGOFF:
    llvm_unreachable("GOFF is not supported yet");
    break;
  case MCContext::IsSPIRV:
    llvm_unreachable("SPIRV is not supported yet");
    break;
  case MCContext::IsWasm:
    llvm_unreachable("WASM is not supported yet");
    break;
  case MCContext::IsXCOFF:
    llvm_unreachable("XCOFF is not supported yet");
    break;
